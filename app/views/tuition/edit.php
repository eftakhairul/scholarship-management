               ...
               <select id="department_name" name="department_name" class="styled">
                   ...
                   <?php foreach ($departments AS $row) : ?>
                       <option value="<?php echo $row['department_name'] ?>"
                           <?php echo ($tuition['department_name'] == $row['department_name'])? "selected = 'selected'" : '' ?> >
                ...
                <select id="year" name="year" class="styled">
                    ...
                    <?php foreach ($this->config->item('years') as $row) : ?>
                        <option value="<?php echo $row ?>"
                            <?php echo (($tuition['year'] == $row)? "selected = 'selected'" : ''); ?> >
                            <?php echo $row ?></option>
                    <?php endforeach ?>
                </select>
           ...
           <p>
                ...
                <select id="semester_id" name="semester_id" class="styled">
                    ...
                    <?php foreach ($this->config->item('semesters') as $key => $row) : ?>
                        <option value="<?php echo $key ?>"
                            <?php echo (($tuition['semester_id'] == $key)? "selected = 'selected'" : ''); ?> >
                            <?php echo $row ?></option>
                    <?php endforeach ?>
                </select>
            ...
            <p>
                ...
                <select id="sex" name="sex" class="styled">
                        ...
                        <option value="2" <?php echo (($tuition['sex'] == 2)? "selected = 'selected'" : ''); ?>> Female</option>
                </select>
            </p>
            ...
            <p>
                ...
                <input id="title" type="text mini" name="credit_fees" class="text" value= "<?php echo $tuition['credit_fees'] ?>" />
